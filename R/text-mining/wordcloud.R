...
buildDictionary(ext_dic = "NIADic", user_dic = data.frame(term = c("서포트백터머신", "k-nn"), tag = c("f", "f")))
buildDictionary(ext_dic = "NIADic", user_dic = data.frame(term = c("서포트백터머신", "k-nn")))
